...
if (userAge < 18){
    ...
    console.log("Sconto 20% per minorenni, il prezzo del tuo biglietto è: €" + ticketPrice);
}   else if (userAge >= 65){
        ticketPrice = (ticketPrice) - ((ticketPrice * 40) / 100);
        console.log("Sconto 40% per over65, il prezzo del tuo biglietto è: €" + ticketPrice);
    }   else{
            console.log("Nessuno sconto attivo, il prezzo del tuo biglietto è: €" + ticketPrice);    
        }